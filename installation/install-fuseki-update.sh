...
wget http://apache.mirror.serversaustralia.com.au/jena/binaries/apache-jena-fuseki-3.9.0.tar.gz -O fuseki.tar.gz
sudo mkdir -p /opt/fuseki
sudo tar -C /opt/fuseki -xzf fuseki.tar.gz --strip 1
sudo rm fuseki.tar.gz
sudo chown -R m13001282105:m13001282105 /opt/fuseki
